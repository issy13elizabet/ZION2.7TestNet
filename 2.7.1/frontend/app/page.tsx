...
import ZionAIWidget from './components/ZionAIWidget';
            ...
            >
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-cyan-400">🤖 10 Active</span>
                </div>
              </div>
              ...
              <div className="space-y-2 border-t border-gray-600 pt-4">
                ...
                <Link 
                  href="/miner"
                  className="block w-full text-center py-2 px-3 bg-orange-600/50 hover:bg-orange-500/50 rounded-lg transition-colors text-orange-200 hover:text-white text-sm"
                >
                  ⛏️ Mining Center
                </Link>
              </div>
