...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const videoMap = {
    'nirvana': 'V2/video/Nirvana.mp4',
    'kundun': 'V2/video/Kundun.mp4',
    'hloupa': 'V2/video/Hloupa.mp4',
    'heart': 'V2/video/HeartSutra.mp4',
    'intro': 'V2/video/w9g.mp4',
    'kalacakra': 'V2/video/start.mp4',
