...
// Použijeme standardní kontejnery namísto google sparsehash kvůli kompatibilitě
...
namespace CryptoNote {
  ...
  typedef std::unordered_map<uint64_t, std::vector<std::pair<TransactionIndex, uint16_t>>> outputs_container; //Crypto::Hash - tx hash, size_t - index of out in transaction
  typedef std::unordered_map<uint64_t, std::vector<MultisignatureOutputUsage>> MultisignatureOutputsContainer;
