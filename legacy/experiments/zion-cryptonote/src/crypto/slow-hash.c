...
// Architecture gating pro AESNI/SSE pouze na x86_64
#if defined(__x86_64__) || defined(_M_X64)
  #define CN_HAVE_AESNI 1
  #include <emmintrin.h>
  #include <wmmintrin.h>
#else
  #define CN_HAVE_AESNI 0
#endif
...
#if CN_HAVE_AESNI
// Include AESNI variant (defines cn_slow_hash_aesni)
#define AESNI
#include "slow-hash.inl"
#undef AESNI
#endif

// Include non-AESNI variant (defines cn_slow_hash_noaes)
#include "slow-hash.inl"
