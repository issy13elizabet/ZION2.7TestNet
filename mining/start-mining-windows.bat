...
echo Pool: 91.98.122.165:3333 (Stratum)
...
if exist config-zion.json (
    ...
    start "XMRig ZION" /min xmrig.exe -o 91.98.122.165:3333 -a rx/0 -u %WALLET% -p %RIG% --rig-id %RIG% -t 12 --donate-level 1 --print-time 60 --retry-pause 5 --retries 5 --log-file xmrig-3333-public.log
 )

echo Miner launched in background (minimized). Logs: xmrig-3333-public.log
