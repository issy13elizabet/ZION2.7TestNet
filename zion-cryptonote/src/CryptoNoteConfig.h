...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x5a49; // ZION prefix
...
const uint64_t MONEY_SUPPLY = UINT64_C(144000000000) * UINT64_C(100000000); // 144 billion ZION with 8 decimals
...
const uint64_t MINIMUM_FEE = UINT64_C(100000); // 0.001 ZION
const uint64_t DEFAULT_DUST_THRESHOLD                        = MINIMUM_FEE;

//TODO Define preferred block's target time
const uint64_t DIFFICULTY_TARGET                             = 120; // seconds (2 minutes)
...
const char     CRYPTONOTE_NAME[]                             = "zion";
const char     GENESIS_COINBASE_TX_HEX[]                     = "013c01ff0001e8ceb4a7dcbe0c029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101984ea84370a8c8b091b611f67994e94ef8b75f79f1c2683450333607e8fe2abe";
